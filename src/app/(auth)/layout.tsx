      ...
      <div className="hidden w-[55%] bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 lg:flex lg:flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-1 flex-col justify-between p-12">
          ...
          <div className="flex items-center justify-between text-xs">
            <div>
              <p className="text-[10px] uppercase tracking-widest text-emerald-200/40">Designed & Developed by</p>
              <a href="https://www.linkedin.com/in/mohamed-insath-90a40724a" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-white hover:text-emerald-200 transition-colors">Mohamed Insath</a>
              <div className="flex items-center gap-4 mt-1">
                <a href="tel:+94750552243" className="flex items-center gap-1.5 text-[12px] text-emerald-200/50 hover:text-emerald-200 transition-colors">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3.5 w-3.5">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                  </svg>
                  +94 750 552 243
                </a>
                <a href="https://wa.me/94750552243" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[12px] text-emerald-200/50 hover:text-emerald-200 transition-colors">
            ...
            <p className="text-xs text-emerald-200/40">&copy; {new Date().getFullYear()} Minal Ledger</p>
          </div>
        </div>
      </div>

      {/* Right Panel - Form */}
      <div className="flex w-full flex-col bg-slate-50/80 px-6 py-12 lg:w-[45%]">
