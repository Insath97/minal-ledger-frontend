...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Right Panel - Form */}
      <div className="flex w-full flex-col bg-background px-5 py-8 sm:px-6 sm:py-12 lg:w-[45%] xl:w-[55%]">
        ...
        <div className="flex flex-1 flex-col items-center justify-center">
          <div className="w-full max-w-[400px]">
            ...
            <div className="mb-10 flex items-center gap-3 lg:hidden">
              ...
              <span className="text-xl font-bold text-foreground tracking-tight">Minal Ledger</span>
            </div>
            {children}
          </div>
        </div>
        ...
        <div className="mt-8 border-t border-border pt-6 lg:hidden">
          <div className="text-center">
            <p className="text-[10px] uppercase tracking-widest text-muted-foreground">Designed & Developed by</p>
            <a href="https://www.linkedin.com/in/mohamed-insath-90a40724a" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-emerald-600 hover:text-emerald-500 transition-colors">Mohamed Insath</a>
            <div className="mt-2 flex items-center justify-center gap-4">
              <a href="tel:+94750552243" className="flex items-center gap-1.5 text-[12px] text-muted-foreground hover:text-foreground transition-colors">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3.5 w-3.5">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                </svg>
                +94 750 552 243
              </a>
              <a href="https://wa.me/94750552243" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[12px] text-muted-foreground hover:text-foreground transition-colors">
          ...
          <p className="mt-3 text-center text-xs text-muted-foreground">&copy; {new Date().getFullYear()} Minal Ledger</p>
        </div>
      </div>
    </div>
  );
