        ...
        <div className="flex flex-col sm:flex-row sm:items-start gap-4">
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900 truncate">{customer.name}</h2>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-slate-50">
            <div className="flex items-center justify-between px-4 sm:px-5 py-2.5">
              ...
              <span className="text-sm text-slate-700 truncate ml-4 text-right">{customer.email || "—"}</span>
            </div>
            <div className="flex items-center justify-between px-4 sm:px-5 py-2.5">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-slate-50">
            <div className="flex items-center justify-between px-4 sm:px-5 py-2.5">
              ...
              <span className="text-sm text-slate-700 text-right truncate ml-4">{customer.address_line1 || "—"}</span>
            </div>
            <div className="flex items-center justify-between px-4 sm:px-5 py-2.5">
              <span className="text-xs text-slate-500">Line 2</span>
              <span className="text-sm text-slate-700 text-right truncate ml-4">{customer.address_line2 || "—"}</span>
            </div>
            <div className="flex items-center justify-between px-4 sm:px-5 py-2.5">
