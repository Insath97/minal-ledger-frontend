    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">Record a new business expense.</p>
        </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="rounded-2xl border border-border bg-background p-4 sm:p-6 shadow-sm">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <select {...register("category")} className="flex h-11 w-full rounded-xl border border-border bg-background px-4 text-sm outline-none transition-all hover:border-border focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20">
        ...
        <div className="rounded-2xl border border-border bg-background p-4 sm:p-6 shadow-sm">
          ...
          <div className="space-y-4">
            {fields.map((field, index) => (
              <div key={field.id} className="rounded-xl border border-border bg-accent/50 p-4">
        ...
        <div className="rounded-2xl border border-border bg-background p-4 sm:p-6 shadow-sm">
          ...
          <textarea {...register("notes")} placeholder="Additional notes about this expense" rows={3} className="flex w-full rounded-xl border border-border bg-background px-4 py-3 text-sm outline-none transition-all placeholder:text-muted-foreground hover:border-border focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20" />
        </div>
