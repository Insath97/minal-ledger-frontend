  ...
  if (!hasPermission("User Create")) {
    return (
      <div className="flex h-[50vh] flex-col items-center justify-center gap-4">
        ...
        <p className="text-sm text-muted-foreground">You don&apos;t have permission to create users.</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">Add a new user to the system.</p>
        </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="rounded-2xl border border-border bg-background p-4 sm:p-6 shadow-sm">
          ...
          <div className="mt-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 p-3.5">
        ...
        <div className="rounded-2xl border border-border bg-background p-6 shadow-sm">
          ...
          <div className="relative" ref={roleDropdownRef}>
            <button
              ...
              className="flex h-11 w-full items-center justify-between rounded-xl border border-border bg-background px-4 text-sm transition-all hover:border-border focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
            >
              {selectedRole ? (
